...
public class CoreInputElement extends ElementBase {
	...
	public final native boolean getCommittedValue() /*-{
		return this.committedValue;
	}-*/;

	public final native void setCommittedValue(String commValue) /*-{
		this.committedValue = commValue;
	}-*/;

	public final native boolean getPreventInvalidInput() /*-{
		return this.preventInvalidInput;
	}-*/;

	public final native void setPreventInvalidInput(boolean status) /*-{
		this.preventInvalidInput = status;
	}-*/;
